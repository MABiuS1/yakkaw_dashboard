...
export const useNotifications = () => {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      setIsCreating(true);
      const r = await fetch(`${API_BASE_URL}/admin/notifications`, {
        method: "POST",
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      setIsUpdating(true);
      const r = await fetch(`${API_BASE_URL}/admin/notifications/${editingId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify(currentForm),
  ...
  const handleDelete = async () => {
    ...
    try {
      setIsDeleting(true);
      const r = await fetch(`${API_BASE_URL}/admin/notifications/${notificationToDelete}`, {
        method: "DELETE",
        credentials: "include",
      });

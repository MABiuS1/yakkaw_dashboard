...
export const useSponsors = () => {
  ...
  const fetchSponsors = useCallback(async (isInitial = false) => {
    ...
    try {
      ...
      const r = await fetch(`${API_BASE_URL}/sponsors`, {
        credentials: "include",
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      setIsCreating(true);
      const r = await fetch(`${API_BASE_URL}/admin/sponsors`, {
        method: "POST",
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      setIsUpdating(true);
      const r = await fetch(`${API_BASE_URL}/admin/sponsors/${editingId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify(currentSponsor),
  ...
  const handleDelete = async () => {
    ...
    try {
      setIsDeleting(true);
      const r = await fetch(`${API_BASE_URL}/admin/sponsors/${sponsorsToDelete}`, {
        method: "DELETE",
        credentials: "include",
      });
